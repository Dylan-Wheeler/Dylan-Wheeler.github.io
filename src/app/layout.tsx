...
import { Inter, Crimson_Text, Nunito, Benne, Habibi, Metamorphous } from "next/font/google";
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${inter.variable} ${crimson_text.variable} ${nunito.variable} ${nunito_light.variable} ${benne.variable} ${habibi.variable} ${metamorphous.variable}`}>
